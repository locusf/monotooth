...
namespace monotooth.Model.Service
{
	...
	public class ServicePool : System.Collections.CollectionBase
	{
		...
		public virtual void Add(monotooth.Model.Device.LinuxDevice.Service ser)
		{
			this.List.Add(ser);
		}
		/// <summary>Removes a service from the pool. </summary>
		/// <param name="ser">A service to be removed from the pool. </param>
		public virtual void Remove(monotooth.Model.Device.LinuxDevice.Service ser)
		{
		...
		public virtual monotooth.Model.Device.LinuxDevice.Service this[int index]
		{
			get
			{
				return (monotooth.Model.Device.LinuxDevice.Service)this.List[index];
			}
			set
			{
				this.List.Add(value);
